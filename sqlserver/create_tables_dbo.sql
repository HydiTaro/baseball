...
--     , CONSTRAINT fk_player_id_1 FOREIGN KEY (player_id_1) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_2 FOREIGN KEY (player_id_2) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_3 FOREIGN KEY (player_id_3) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_4 FOREIGN KEY (player_id_4) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_5 FOREIGN KEY (player_id_5) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_6 FOREIGN KEY (player_id_6) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_7 FOREIGN KEY (player_id_7) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_8 FOREIGN KEY (player_id_8) REFERENCES player_master(player_id)
--     , CONSTRAINT fk_player_id_9 FOREIGN KEY (player_id_9) REFERENCES player_master(player_id)
-- );
GO
