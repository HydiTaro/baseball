...
/**
 * 
 * サイト機能02を実装するクラス：打順入れ替えで得点率を検証する機能。返却値は、平均得点、無得点試合数、
 * <p>
 * 本クラスのフィールドのデータは一試合ごとにリセットされる
 * <p>
 * 打者データ：画面入力した簡易的なもの。
 * TODO　将来的には、得点レポートを分布図で比較したい。
 * 
 */
@Data
public class InningStrategy02 implements InningStrategy {
